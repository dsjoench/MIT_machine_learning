...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    if z > 1:
        ...
        return 1-z
    # return label-(np.matmul(theta,feature_vector)+theta_0)
...
def hinge_loss_full(feature_matrix, labels, theta, theta_0):
    ...
    for vector in feature_matrix:
        ...
        hinge_loss_ls.append(hinge_loss_single(vector, labels[idx], theta, theta_0))
        idx+=1
    return np.average(hinge_loss_ls)
...
def perceptron_single_step_update(
    ...
    # print(f'current_theta_0 {current_theta_0}')
